      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 w-full p-3 bg-white/10 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500 placeholder-gray-500"
/>
...
/>
        ...
        <div className="relative">
          <User className="absolute left-3 top-3 h-5 w-5 text-white-400" />
          <input
            type="text"
